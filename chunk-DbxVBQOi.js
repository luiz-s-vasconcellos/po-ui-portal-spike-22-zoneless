...
`),Lp(),nw("p-disabled",d.form.invalid),Lp(5),Ew("ngModel",o.title),e0(),Lp(),Ew("ngModel",o.icon),nw("p-options",o.iconOptions),e0(),Lp(),Ew("ngModel",o.content),e0(),Lp(),Ew("ngModel",o.primaryActionLabel),e0(),Lp(),Ew("ngModel",o.primaryActionIcon),e0(),Lp(),Ew("ngModel",o.primaryActionProperties),nw("p-options",o.primaryActionOptions),e0(),Lp(),Ew("ngModel",o.secondaryActionLabel),e0(),Lp(),Ew("ngModel",o.secondaryActionIcon),e0(),Lp(),Ew("ngModel",o.secondaryActionProperties),nw("p-options",o.secondaryActionOptions),e0(),Lp(),Ew("ngModel",o.size),nw("p-options",o.sizeOptions),e0(),Lp(),Ew("ngModel",o.properties),nw("p-options",o.propertiesOptions),e0(),Lp(),Ew("ngModel",o.componentsSize),nw("p-options",o.componentsSizeOptions),e0();}},dependencies:[G9,$9,z9,mk,hk,Qt,mv,C3,F3,Dde,qhe,Yo],encapsulation:2,changeDetection:1})}return a})();var ve=a=>({"docs-sample-code-tabs":a}),ce=(()=>{class a{hideSampleCodeTabs=true;sampleCodeButtonLabel="Talk is cheap, show me the code!";sampleCodeButtonIcon="an an-plus";toggleSampleCodeTabs(){this.hideSampleCodeTabs=!this.hideSampleCodeTabs,this.sampleCodeButtonLabel=this.hideSampleCodeTabs?"Talk is cheap, show me the code!":"Okay, hide the code",this.sampleCodeButtonIcon=this.hideSampleCodeTabs?"an an-plus":"an an-minus";}static \u0275fac=function(l){return new(l||a)};static \u0275cmp=Un({type:a,selectors:[["sample-po-modal-labs-view"]],standalone:false,decls:24,vars:6,consts:[[1,"sample-blockquote"],[1,"sample-title","po-font-text-large-bold"],[1,"show-me-the-code",3,"click"],[3,"ngClass"],["p-size","2"],["p-label","HTML","p-active",""],[1,"doc-label-path"],["appCodeHighlight","",1,"html"],["p-label","TS"],["appCodeHighlight","",1,"typescript"],[1,"docs-sample-container"]],template:function(l,o){l&1&&(zl(0,"br"),Il(1,"blockquote",0)(2,"label",1),Qx(3,"PO Modal Labs"),og(),Il(4,"a",2),ft("click",function(){return o.toggleSampleCodeTabs()}),zl(5,"span"),Qx(6),og()(),Il(7,"div",3)(8,"po-tabs",4)(9,"po-tab",5)(10,"div")(11,"label",6),Qx(12,"sample-po-modal-labs/sample-po-modal-labs.component.html"),og(),Il(13,"pre",7),Qx(14,`<po-modal
